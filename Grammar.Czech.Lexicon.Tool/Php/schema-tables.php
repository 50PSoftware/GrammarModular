...
const LEXICON_TABLES = [
    ...
    'semantic_relation' => [
        'relation_id', 'lu_id_a', 'lu_id_b', 'relation_type', 'antonym_subtype', 'strength', 'source',
        'note', 'is_verified',
    ],
];
...
const LEXICON_ENUMS = [
    ...
    // Způsob slovesného děje podle NESČ, hesla ZPŮSOB SLOVESNÉHO DĚJE. Není to jemnější vid: vid má
    // každé sloveso, tohle je lexikální třídění a většina sloves do žádné skupiny nepatří.
    'aktionsart' => [
        'Ingressive' => 'ingresivní – začátek (zakašlat)',
        'Evolutive' => 'evolutivní – rozběh (rozplakat se)',
        'Delimitative' => 'delimitativní – chvíli (posedět)',
        'Resultative' => 'rezultativní – výsledek (napsat)',
        'Terminative' => 'terminativní – provedení (přečíst)',
        'Perdurative' => 'perdurativní – po celou dobu (propracovat)',
        'Finitive' => 'finitivní – dokončení zbytku (dočíst)',
        'Egressive' => 'egresivní – ustání (odzvučet)',
        'Exhaustive' => 'exhaustivní – vyčerpání konatele (utancovat)',
        'Total' => 'totální – celý předmět (pročistit)',
        'Saturative' => 'saturativní – nasycení (najíst se)',
        'Extensive' => 'extenzivní – přes míru (napracovat se)',
        'Cumulative' => 'kumulativní – nahromadění (nahrabat)',
        'Intensive' => 'intenzivní – důkladně (načadit)',
        'Excessive' => 'excesivní – přehnání (přesolit)',
        'Distributive' => 'distributivní – postupně po jednom (pozamykat)',
        'Attenuative' => 'atenuativní – trochu (přimodřit)',
        'Semelfactive' => 'semelfaktivní – jednou (kopnout)',
        'Momentary' => 'momentální – bez trvání (hodit)',
        'Iterative' => 'iterativní – návykové -ívat/-ávat (dělávat)',
        'Diminutive' => 'deminutivní – pomalu a opakovaně (pospávat)',
        'Comitative' => 'komitativní – doprovodné (přizvukovat)',
        'Frequentative' => 'frekventativní – opakování jednoho aktu (kopat)',
        'Stative' => 'stavové (sedět)',
        'Decursive' => 'dekurzivní – prostě probíhá (psát)',
        'Mutative' => 'mutativní – postupná změna (černat)',
    ],
    'reflexive_type' => [
        'None' => 'bez reflexiva',
...
const LEXICON_PATTERNS = [
    ...
    'Verb' => [
        ...
        'bere', 'běžet', 'být', 'chtít', 'cítit', 'číst', 'dát', 'dělá', 'dostat', 'hrát', 'jet', 'jíst', 'jít',
